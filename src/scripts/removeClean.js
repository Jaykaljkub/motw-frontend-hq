...
export function removeClean(firebaseRef, valueMaybeUndefined) {
  ...
  console.log("removeClean", targetPath, valueNeverUndefined);
  return remove(targetRef, valueNeverUndefined);
}