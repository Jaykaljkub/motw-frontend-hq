<template>
    <div class="top-msg" ref="lettersRefUnAuth">
        <svg class="top-slash" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500"
            style="enable-background:new 0 0 500 500;" xml:space="preserve">
            <g id="DESIGN">
                <g>
                    <polygon class="st0"
                        points="88.33,250 78.33,250 78.33,421.67 250,421.67 250,411.67 88.33,411.67 		" />
                    <polygon class="st0"
                        points="250,78.33 250,88.33 411.67,88.33 411.67,250 421.67,250 421.67,78.33 		" />
                    <rect x="245" y="14.3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -103.5534 249.9995)"
                        class="st0" width="10" height="471.4" />
                </g>
            </g>
        </svg>
        <span v-for="(char, index) in splitTextUnauth" :key="index" class="letter-unauth"
            :style="{ whiteSpace: char === ' ' ? 'pre' : 'normal' }">
            {{ char }}
        </span>
    </div>

    <svg class="unauth-backgr" version="1.1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500"
        style="enable-background:new 0 0 500 500;" xml:space="preserve">
        <g id="DESIGN">
            <g>
                <path class="st0"
                    d="M421.57,415.69c-0.06-0.32-0.16-0.63-0.29-0.94c-0.12-0.3-0.28-0.59-0.46-0.86
                ...
                <path class="st0"
                    d="M80.56,87.49c0.27,0.18,0.56,0.34,0.86,0.46c0.3,0.13,0.62,0.22,0.94,0.29c0.32,0.06,0.65,0.09,0.97,0.09
                ...
                <path class="st0"
                    d="M420.2,79.8c-1.95-1.95-5.12-1.95-7.07,0L79.8,413.13c-1.95,1.95-1.95,5.12,0,7.07
                    c0.98,0.98,2.26,1.46,3.54,1.46s2.56-0.49,3.54-1.46L420.2,86.87C422.16,84.92,422.16,81.75,420.2,79.8z" />
                <path class="st0"
                    d="M420.2,163.13c-1.95-1.95-5.12-1.95-7.07,0l-250,250c-1.95,1.95-1.95,5.12,0,7.07
                    c0.98,0.98,2.26,1.46,3.54,1.46s2.56-0.49,3.54-1.46l250-250C422.16,168.25,422.16,165.08,420.2,163.13z" />
                <path class="st0"
                    d="M420.2,246.46c-1.95-1.95-5.12-1.95-7.07,0L246.46,413.13c-1.95,1.95-1.95,5.12,0,7.07
                    c0.98,0.98,2.26,1.46,3.54,1.46s2.56-0.49,3.54-1.46L420.2,253.54C422.16,251.58,422.16,248.42,420.2,246.46z" />
                <path class="st0"
                    d="M420.2,329.8c-1.95-1.95-5.12-1.95-7.07,0l-83.33,83.33c-1.95,1.95-1.95,5.12,0,7.07
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const splitTextUnauth = ref(text.split("")); // Splitting text into letters
            const lettersRefUnAuth = ref(null); // Reference to the span container
            ...
            onMounted(async () => {
                ...
                if (lettersRefUnAuth.value) {
                    tl2.from(lettersRefUnAuth.value.querySelectorAll('.letter-unauth'), {
                        opacity: 0,
                        duration: 0.6,
                        delay: 0.3,
                        ease: "power3.out",
